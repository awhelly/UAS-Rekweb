...
<div class="intro-y flex items-center mt-8">
	<h2 class="text-lg font-medium mr-auto">Form Tambah Data Produk</h2>
</div>
		...
		<form action="{{ route('produk-store') }}" method='POST'>
			...
			<div class="mt-3">
				<div>
					...
					<input id="qty" type="number" class="form-control w-full" name="qty" >
				</div>
			</div>
			<div class="mt-3">
				<div>
					<label for="crud-form-1" class="form-label">Satuan</label>
					<input id="satuan" type="text" class="form-control w-full" name="satuan" >
				</div>
			</div>
			<div class="mt-3">
				<div>
					<label for="crud-form-1" class="form-label">Harga</label>
					<input id="harga" type="number" class="form-control w-full" name="harga" >
				</div>
			</div>
			<div class="mt-3">
