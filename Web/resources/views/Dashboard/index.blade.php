...
<div class="grid grid-cols-12 gap-6 mt-5">
	<div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
		<a href="{{ route('dashboard-create') }}"><button class="btn btn-primary shadow-md mr-2">
				...
				<tbody>
					...
					<tr class="intro-x">
						...
						<td class="table-report__action w-56">
							...
							<form action="{{ route('dashboard-destroy', $value['id']) }}" method='POST'>
								@csrf
								@method('delete')
								<div class="flex justify-center items-center">
									<a class="flex items-center mr-3" href="{{ route('dashboard-edit', $value['id']) }}">
